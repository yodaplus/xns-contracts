...
async function setTLDsOnRoot(owner, root, registrar, tlds) {
    console.log("🚀 ~ file: 10_set_tlds.js ~ line 13 ~ setTLDsOnRoot ~ owner", owner)
    ...
    for (const tld of tlds) {
        ...
        transactions.push(await rootOwner.setSubnodeOwner(labelhash, registrar.address,));
    }
    console.log("🚀 ~ file: 10_set_tlds.js ~ line 23 ~ setTLDsOnRoot ~ transactions", transactions)
    return transactions;
}
